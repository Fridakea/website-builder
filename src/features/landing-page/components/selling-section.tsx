  ...
  return (
    <div className="max-w-content mx-auto relative z-10 rounded-4xl bg-background-tint py-16 px-4 sm:p-20 flex flex-col gap-8 sm:gap-16">
      <div className="flex flex-col-reverse gap-10 sm:flex-row">
        <div className="flex-[1.5] flex flex-col items-start justify-center gap-4 sm:gap-5">
      ...
      <dl className="p-6 sm:p-8 gap-1 bg-card grid grid-cols-2 overflow-hidden rounded-2xl text-center sm:grid-cols-3 lg:grid-cols-6">
        {stats.map((stat) => (
